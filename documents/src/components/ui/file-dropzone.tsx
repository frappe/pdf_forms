...
export const FileTypeIcon = ({
    ...
    const renderFileTypeIcon = (iconClassName?: string) => {
        switch (fileType.toLowerCase()) {
            case 'pdf':
                return (
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className={cn("text-white", iconSizeClasses[size], iconClassName)}>
            ...
            case 'pptx':
                return (
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 116.03" className={cn("text-white", pptIconSizeClasses[size], iconClassName)}>
                        <g>
            ...
            default:
                return (
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={cn("text-white", iconSizeClasses[size], iconClassName)}>
    ...
    return (
        <div className={cn("flex items-center justify-center")}>
            {renderFileTypeIcon(getTextColor())}
        </div>
    )
}